...
extern "C" void func_lm(Para* master_lm){
   ...
   int r=pl.r;
   float slave_diff[6400]={0};
   float slave_blur[6400]={0};

   float slave_weight[6400]={0};
   float slave_out[6400]={0};
...
extern "C" void func1(Para* master_den){
   ...
   int r=pd.r;
    ...
    float slave_diff[10000]={0};
    float slave_blur[10000]={0};
...
extern "C" void func_reduce(Para* master_den){
   ...
   int X_block=core_block_X/64;// 4096*78/64
   int Y_block=core_block_Y/64;// 4096*12*4/64
   float result_X[4992];
   float result_Y[3072];
